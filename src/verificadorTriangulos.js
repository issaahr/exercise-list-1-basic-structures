...
const ladoA = Number(prompt("Insira um valor para o primeiro lado: "));
const ladoB = Number(prompt("Insira um valor para o segundo lado: "));
const ladoC = Number(prompt("Insira um valor para o terceiro lado: "));
